...
class GameTest(unittest.TestCase):
    ...
    def test_validations_of_covering_moves(self):
        ...
        # if the above was done via execute_move and Move object, the heat update would be included
        test_game.board.update_heat_map('w')
        test_game.board.update_heat_map('b')
        # |br|  |  |  |bk|  |  |  |
        # |  |wr|  |bb|  |  |  |  |
        # |  |  |  |  |  |  |  |  |
        # |  |wb|  |  |bq|  |  |  |
