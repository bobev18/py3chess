...
class TemporaryGameTest(unittest.TestCase):
    ...
    def test_validations_of_history_moves(self):
        test_game = Game()
        test_game.whites_player.simulate(['e4', 'Nf3', 'Bc4', 'b4', 'Kf1', 'Ke1', 'O-O', 'draw'])
        test_game.blacks_player.simulate(['a5', 'a4', 'Nc6', 'h6', 'axb3', 'bxa2', 'h5'])
        # self.assertEqual('stalemate', test_game.start(verbose=False))
